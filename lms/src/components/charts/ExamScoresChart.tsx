        ...
        {scores.map((exam, index) => {
          ...
          return (
            <motion.div
              ...
              className="bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-2xl p-6 transition-all hover:bg-slate-100 dark:hover:bg-white/10 group"
            >
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-3">
                  <span className="text-sm font-black text-slate-900 dark:text-white uppercase tracking-tight">{exam.module}</span>
                  {trendIcon}
                </div>
              ...
              <div className="h-1.5 bg-slate-100 dark:bg-white/5 rounded-full overflow-hidden ring-1 ring-slate-200 dark:ring-white/5">
                <motion.div
                  initial={{ width: 0 }}
