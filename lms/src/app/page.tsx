          ...
          <div className="mx-auto mt-10 flex flex-wrap justify-center gap-3">
            {[
              ...
              >
                ...
                <span className="mt-0.5 text-[11px] font-semibold uppercase tracking-wider text-white/60">{label}</span>
              </div>
            ))}
          </div>
                  ...
                  >
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="min-w-0">
                        <p className="text-[10px] font-bold uppercase tracking-wider text-white/40">Module {mod.num}</p>
                    ...
                    <p className="mt-3 text-[11px] font-semibold text-white/40">{mod.lessons} leçons</p>
                  </div>
                );
              })}
