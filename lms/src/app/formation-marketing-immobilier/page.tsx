...
const PAGE_PATH = "/formation-marketing-immobilier";
const MODULE_ID = "marketing";

export const metadata: Metadata = {
  title: "Formation Marketing Immobilier & Conformité ALUR 2026 | 8h en ligne",
  description:
  ...
  keywords: [
    "formation marketing immobilier",
  ...
  openGraph: {
    title: "Formation Marketing & Conformité Immobilier 8h",
    description:
    ...
    images: [
      {
        ...
        width: 1024,
        height: 576,
        alt: "Formation Marketing et Conformité Immobilière",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "Formation Marketing Digital Immobilier en ligne",
    description:
    ...
    "@graph": [
      {
        ...
        itemListElement: [
          ...
          },
          {
            "@type": "ListItem",
            position: 2,
            name: "Formation Marketing Immobilier",
            item: pageUrl,
          },
        ],
      },
      {
        ...
        "@id": `${pageUrl}#course`,
        url: pageUrl,
        name: "Formation Marketing & Conformité Immobilier — Module 8h",
        description:
          ...
          <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
            <div className="max-w-3xl">
              ...
              <h1 className="mt-4 text-4xl font-black leading-tight sm:text-5xl lg:text-6xl">
                Formation Marketing &amp; Conformité Immobilier (8h)
              </h1>
            ...
            <div className="lg:col-span-2 space-y-8">
              <div className="rounded-3xl border border-zinc-200 bg-white p-8 shadow-sm">
                <h2 className="text-2xl font-black text-brand-navy">
                  Programme du module Marketing (8 heures)
                </h2>
