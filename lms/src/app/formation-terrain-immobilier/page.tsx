...
const PAGE_PATH = "/formation-terrain-immobilier";
const MODULE_ID = "terrain";

export const metadata: Metadata = {
  title: "Formation Terrain Immobilier & Conformité ALUR 2026 | 8h en ligne",
  description:
  ...
  openGraph: {
    title: "Formation Terrain & Conformité Immobilier 8h",
    description:
    ...
    images: [
      {
        ...
        width: 1024,
        height: 576,
        alt: "Formation Terrain et Conformité Immobilière",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "Formation Visite & Fidélisation Client en ligne",
    description:
    ...
    "@graph": [
      {
        ...
        itemListElement: [
          ...
          },
          {
            "@type": "ListItem",
            position: 2,
            name: "Formation Terrain Immobilier",
            item: pageUrl,
          },
        ],
      },
      {
        ...
        "@id": `${pageUrl}#course`,
        url: pageUrl,
        name: "Formation Terrain & Conformité Immobilier — Module 8h",
        description:
          ...
          <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
            <div className="max-w-3xl">
              ...
              <h1 className="mt-4 text-4xl font-black leading-tight sm:text-5xl lg:text-6xl">
                Formation Terrain &amp; Conformité Immobilier (8h)
              </h1>
            ...
            <div className="lg:col-span-2 space-y-8">
              <div className="rounded-3xl border border-zinc-200 bg-white p-8 shadow-sm">
                <h2 className="text-2xl font-black text-brand-navy">
                  Programme du module Terrain (8 heures)
                </h2>
