...
| **Score global minimum** | **70 %** |
| **Tous les modules doivent être validés** | Oui (5/5) |
| **Complétion des leçons** | **≥ 80 %** |

## Composition des examens
- **5 examens** (un par module).
- **~15 à 25 questions** par examen (total 78 questions réparties).
- **Durée** : 15 minutes par examen.
- **Notation** : 1 point par question. Les questions ouvertes sont notées par l'IA coach (seuil de validation : 70/100).

## Tentatives et carence
...
Le certificat est délivré lorsque :
