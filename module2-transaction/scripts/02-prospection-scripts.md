# SCRIPT VIDÉO 2 - MODULE 2 : TRANSACTION
...
```
Modern real estate agent in co-working space, making phone calls with headset, multiple screens showing CRM and property listings, dynamic energy, blue and orange accent lighting, professional yet approachable atmosphere, photorealistic, 4K --ar 16:9 --v 6
```
...
[B-ROLL : Scènes d'appels ratés, agents qui lisent des scripts robotiques, prospects qui raccrochent]

"Le problème avec la prospection, c'est qu'on vous a appris à... réciter. 'Bonjour, je suis agent immobilier, je vous dérange ?' [PAUSE 2s] STOP. Arrêtez ça immédiatement."
...
"Voici trois accroches qui fonctionnent. À adapter selon votre cible."
...
"Utilisez les questions ouvertes. 'Qu'est-ce qui vous ferait dire que c'est le bon moment pour vendre ?' 'Qu'est-ce qui est le plus important pour vous dans cette recherche ?' 'Racontez-moi votre projet...'"
...
"Quatrième pilier : la conclusion. Vous ne raccrochez JAMAIS sans objectif clair. Jamais."
...
"Agent : 'Je comprends. C'est un gros projet. Vous cherchez plutôt dans quel type de quartier ? Plutôt centre-ville, ou vous êtes ouverts aux communes autour ?'"

[B-ROLL : Prospect qui explique]

"Prospect : 'On aimerait bien le 6ème ou le 3ème, mais c'est cher. On regarde aussi Villeurbanne.'"

[B-ROLL : Agent qui repère l'opportunité]

"Agent : 'D'accord. Et au niveau budget, vous êtes sur quelle fourchette, si ce n'est pas indiscret ?'"

[B-ROLL : Prospect qui répond]

"Prospect : 'On aimerait rester sous 350 000 euros, mais c'est compliqué pour trois pièces.'"

[B-ROLL : Agent qui sourit]

"Agent : 'Je vois. Écoutez, j'ai peut-être quelque chose pour vous. On vient de prendre un mandat dans le 3ème, rue Moncey, un trois-pièces de 65m² à 340 000 euros. Il n'est pas encore en ligne. Ça vous intéresserait de le visiter en avant-première ?'"

[B-ROLL : Prospect intéressé]

"Prospect : 'Oh, oui, carrément ! Quand est-ce qu'on peut voir ça ?'"

[B-ROLL : Agent qui ouvre son agenda]

"Agent : 'Je vous propose demain à 18h, ou jeudi à 12h30. Qu'est-ce qui vous arrange le mieux ?'"

[B-ROLL : Prospect qui réfléchit]

"Prospect : 'Jeudi midi, ce serait parfait.'"
...
"Agent : 'À jeudi alors, bonne journée Madame Lefranc !'"
...
"À vous de jouer. On se retrouve dans la prochaine vidéo pour apprendre à transformer ces rendez-vous en... mandats signés. À bientôt !"
